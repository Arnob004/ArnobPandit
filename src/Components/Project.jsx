...
const Project = ({ DarkMode }) => {
    ...
    const projects = [
        {
            imgSrc: "https://s.tmimgcdn.com/scr/1200x627/203100/marketkit-multipurpose-ecommerce-html-website-template_203166-original.jpg",
            bgColor: "bg-white"
        },
        {
        ...
        {
            imgSrc: "https://wrapmarketusercontent.com/assets/items/thumb/1c24602646588855a73729768ab99a4b5ba7b782b5faba3f8fbf16d5d3e3bf55.webp?v=1710580878",
            bgColor: "bg-white"
        },
        {
    ...
    return (
        <section className="w-full mt-32 px-4 sm:px-8 md:px-12 lg:px-20" id="projects">
            {/* Section Heading */}
            <motion.h2
